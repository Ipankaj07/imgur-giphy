let content = document.getElementById("content")
        ...
        const image = async (query) => {
            ...
            let res = await fetch(`https://giphy.p.rapidapi.com/v1/gifs/search?api_key=dc6zaTOxFJmzC&q=${query}`, {
                "method": "GET",
                "headers": {
                    "x-rapidapi-host": "giphy.p.rapidapi.com",
                    "x-rapidapi-key": "84f27faa4amsha91357a0cc9492ep16b406jsn0877d4ddd52b"
        ...
        function getQuery(query) {
            try {
                fetch(`https://api.giphy.com/v1/gifs/search?q=${query}&api_key=SOc2GyQ7rK9nRUE90XVZudwEznWtpKFA&limit=5`)
                    .then((d) => d.json())
                    .then((res) => {
